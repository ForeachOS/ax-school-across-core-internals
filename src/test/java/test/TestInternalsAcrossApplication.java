...
import com.foreach.across.school.internals.InternalsAcrossApplication;
 ...
 * If no database has been configured, default configuration will use a memory database (if available on the classpath).
 */
@RunWith(SpringJUnit4ClassRunner.class)
@WebAppConfiguration
@SpringBootTest(classes = { InternalsAcrossApplication.class, MockMvcConfiguration.class })
@ActiveProfiles("integration-test")
@ContextConfiguration(initializers = MockAcrossServletContextInitializer.class)
public class TestInternalsAcrossApplication
{
	@Autowired
